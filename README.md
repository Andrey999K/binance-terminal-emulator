...
Помимо вашего ордера в истории ордеров раз в секунду герерируется ордер с рандомными значениями в определённом диапозоне, чтобы создать видимость ордеров других трейдеров.

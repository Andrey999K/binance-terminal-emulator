...
**Компонент FormsOrder:** <br>
    ...
    Принимает 3 пропса:<br>
        1) _available_ — данные об имеющейся паре криптовалют<br>
        2) _createOrder_ — функция для создания нового ордера<br>
        3) _dataCurrency_ — данные о текущем курсе криптовалюты<br>
